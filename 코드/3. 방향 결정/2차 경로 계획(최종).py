...
binary_mask = cv2.imread('pr_1.png', cv2.IMREAD_GRAYSCALE)
binary_mask = cv2.resize(binary_mask, (2048, 1024))
...
for result in results:
    ...
    for box in boxes:
        ...
        if class_id >= 0 and class_id <= 7:
            ...
            cv2.rectangle(overlay_image, (x1_pad, y1_pad), (x2_pad, y2_pad), (0, 255, 255), 3)  # 위험 경계 상자 그리기
